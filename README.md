...
1. search for "com_github_gonzojive_rules_sass" and replace with the name you'll use for your workspace
1. search for "gonzojive" and replace with GitHub org
1. search for "sass" and replace with the language/tool your rules are for
1. rename directory "sass" similarly
...
<https://github.com/gonzojive/rules_sass/releases>
